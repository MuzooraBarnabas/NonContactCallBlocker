...
/**
 * Resets strict mode to the given [StrictMode.ThreadPolicy] after the given block.
 * This acts like [kotlin.io.use].
 */
fun <T> StrictMode.ThreadPolicy.resetAfter(block: () -> T): T {
    return block().also {
